...
def test_compute_coverage_data_tracks_explicit_and_inferred_coverage():
    ...
    cards = [
        {
            "fields": {
                "Front": "What are fixed costs?",
                "Back": "Costs that stay constant.",
            },
            "source_pages": [1],
            "concept_ids": ["c1"],
        },
        {
            "fields": {
                "Front": "Contrast fixed and variable costs.",
                "Back": "They behave differently with activity.",
            },
            "source_pages": [2],
    ...
    coverage = compute_coverage_data(
        cards=cards, concept_map=concept_map, total_pages=3
    )
...
def test_generation_gap_text_mentions_relations_and_saturated_pages():
    ...
    coverage = compute_coverage_data(
        cards=cards, concept_map=concept_map, total_pages=2
    )

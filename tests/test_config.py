...
from lectern.config import ConfigManager, save_user_config, __getattr__


class TestConfigManagerSingleton:
    """Test ConfigManager singleton behavior."""

    def test_singleton_returns_same_instance(self, isolated_config: None) -> None:
    ...
    def test_reset_instance_allows_new_instance(self, isolated_config: None) -> None:
    ...
    def test_singleton_persists_across_calls(self, isolated_config: None) -> None:
...
class TestConfigPriority:
    ...
    def test_default_value_when_no_override(self, isolated_config: None) -> None:
        """Returns default when no env var or user config exists."""
        config = ConfigManager.instance()

        # gemini_model has a default value
        assert config.get("gemini_model") == "gemini-3-flash-preview"

    def test_env_var_overrides_default(self, isolated_config: None) -> None:
    ...
    def test_user_config_overrides_default(
        self, isolated_config: None, temp_config_dir: Path
    ) -> None:
    ...
    def test_explicit_default_parameter(self, isolated_config: None) -> None:
    ...
    def test_none_for_missing_key_without_default(self, isolated_config: None) -> None:
...
class TestConfigGetSet:
    ...
    def test_set_and_get_value(self, isolated_config: None) -> None:
    ...
    def test_set_overwrites_existing(self, isolated_config: None) -> None:
    ...
    def test_get_all_returns_copy(self, isolated_config: None) -> None:
    ...
    def test_env_mapping_for_different_keys(self, isolated_config: None) -> None:
...
class TestConfigPersistence:
    ...
    def test_load_handles_malformed_json(
        self, isolated_config: None, temp_config_dir: Path, caplog
    ) -> None:
    ...
    def test_save_handles_write_error(
        self, isolated_config: None, caplog
    ) -> None:
...
class TestLegacyPathMigration:
    ...
    def test_migrates_legacy_config(
        self, isolated_config: None, temp_config_dir: Path
    ) -> None:
...
class TestDynamicAttributeAccess:
    ...
    def test_module_level_attribute_access(self, isolated_config: None) -> None:
    ...
    def test_module_attribute_for_anki_url(self, isolated_config: None) -> None:
    ...
    def test_invalid_attribute_raises(self, isolated_config: None) -> None:
...
class TestSaveUserConfigHelper:
    ...
    def test_save_user_config_delegates_to_manager(
        self, isolated_config: None, temp_config_dir: Path
    ) -> None:
...
class TestConfigDefaults:
    ...
    def test_all_defaults_are_defined(self, isolated_config: None) -> None:

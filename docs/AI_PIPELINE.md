...
Lectern uses Google Gemini 3.0 Flash as the core engine for multimodal flashcard generation. The pipeline is orchestrated by `lectern_service.py` and strictly interacts via `ai_client.py`.

...
describe.skipIf(!apiKey)('pipeline live E2E', () => {
  it('turns a PDF into gated, grounded cards and syncs them to Anki', { timeout: 600_000 }, async () => {
    ...
    console.log(`created=${result.created} updated=${result.updated} failed=${result.failures.length}`)
